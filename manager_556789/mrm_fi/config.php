...
$config['authentication'] = function() {
	...
	if ($_SESSION['IsAuthorized']=='binhnv')
		return true;
	else
		return false;
...
$config['images'] = array(
    ...
    'quality'   => 99,
    'sizes' => array(
        'small'  => array('width' => 480, 'height' => 320, 'quality' => 90),
        'medium' => array('width' => 600, 'height' => 480, 'quality' => 90),
        'large'  => array('width' => 800, 'height' => 600, 'quality' => 90)
    )
);
