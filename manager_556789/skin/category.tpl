  ...
  <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td>
          <div id="cls_category">{parentid}</div>
        </td>
      </tr>
      <!--
            <tr>
    ...
    <td>
      ...
      <tr>
        ...
        <td>
          <div id="pic_avataradv">{imageadv}</div>
          <div class="c5"></div>
          <div class="input-append">
            <input name="imageurladv" type="text" id="imageurladv" style="height:20px; width:290px;"
              value="{imageurladv}" />
      ...
      <tr>
        <td colspan="2" id="show_collection_cell">
          ...
          <div class="collection_cell">
            <div class="image"><a href="{big_image}" class="highslide" onClick="return hs.expand(this)"><img
                  src="{image}"></a></div>
            <input name="image_name[collection_{id}]" type="text" class="txtname name_image" placeholder="Tiêu đề..."
              value="{name}" />
            <textarea name="image_desc[collection_{id}]" class="txtname" style="height:60px;resize:none; "
              placeholder="Mô tả...">{image_desc}</textarea>
            <div style="padding-left:10px;"><span class="labelorder">Thứ
                tự</span>
              <input name="image_thu_tu[collection_{id}]" type="text" class="txtorder image_thu_tu"
                placeholder="Thứ tự..." value="{thu_tu}">
      ...
      <tr>
        ...
        <td><textarea name="description" id="description" class="txtareakeyword-description">{description}</textarea>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style="position:relative">
          ...
          <div style="font-size:11px; color:#666; font-style:italic">Checked tự
            động tạo url/Uncheck lấy url trên ô text</div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>
          <div onclick="$('#inputform').submit();
                        return false" class="btn btn-primary"><i class="icon-ok-circle icon-white"></i>&nbsp;Cập nhật
          </div>
          <div onclick="window.location = '?page={par_page}&pid={pid}'" class="btn btn-inverse"
            style="margin-left:10px;"><i class="icon-remove icon-white"></i>&nbsp;Đóng</div>
        </td>
      </tr>
    </table>
  </form>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
      ...
      <tr class="title">
        <td>Tiêu đề
          ...
          </span> <span style="float:right;"> / </span> <span class="collapse-all-child" style="float:right;"> Thu gọn
            &nbsp;
          </span>
      ...
      <tr class="{child-cat}">
        ...
        <td class="center"><input type="checkbox" name="active" value="1" data-active="{id}" {active}
            class="changeactive" /></td>
