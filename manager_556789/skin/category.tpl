...
<div class="wraper-content">
  ...
  <form action="{action}" method="post" id="inputform"
    onSubmit="return check_null();" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
      class="table-bordered tabletdnone">
      <tr>
        <th colspan="2"><i class="icon-pencil"></i>&nbsp;Quản lý {item}</th>
      </tr>
      <tr>
        <td width="150"><strong>Tiêu đề</strong></td>
        <td><input type="text" name="name" id="name" class="txtform100 notNull"
            data-alert="Bạn cần nhập vào tiêu đề {item}" value="{name}" /></td>
      </tr>
      <tr>
        <td><strong>Tiêu đề phụ</strong></td>
        <td><input type="text" name="subname" class="txtform100"
            value="{subname}" /></td>
      </tr>

      <tr>
        <td><strong>Page title</strong></td>
        <td><input type="text" name="title" id="title" class="txtform100"
            value="{title}" /></td>
      </tr>
      ...
      <tr>
        ...
        <td><ul class="fr_location borderright-FFF" id="choose_datatype">
            ...
            <li id="news">
              <label class="radio">
                <input type="radio" name="data_type" value="news"
                  class="data_type" {news} />
                Tin tức</label>
            </li>

            <li id="info">
              <label class="radio">
                <input type="radio" name="data_type" value="info"
                  class="data_type" {info} />
                Giới thiệu</label>
            </li>

            <!-- <li id="info_leader">
              <label class="radio">
                <input type="radio" name="data_type" value="info_leader"
                  class="data_type" {info_leader} />
                Giới thiệu nhân sự</label>
            </li>

            <li id="info_donvi">
              <label class="radio">
                <input type="radio" name="data_type" value="info_donvi"
                  class="data_type" {info_donvi} />
                Đơn vị thành viên</label>
            </li>

            <li id="info_lichsu">
              <label class="radio">
                <input type="radio" name="data_type" value="info_lichsu"
                  class="data_type" {info_lichsu} />
                Lịch sử hình thành</label>
            </li> -->

            <li id="article">
              <label class="radio">
                <input type="radio" name="data_type" value="article"
                  class="data_type" {article} />
                Bài viết </label>
            </li>

            <li id="daily">
              <label class="radio">
                <input type="radio" name="data_type" value="daily"
                  class="data_type" {daily} />
            ...
            <li id="product">
              <label class="radio">
                <input type="radio" name="data_type" value="product"
                  class="data_type" {product} />
                Trang sản phẩm</label>
            </li>

            <li id="du_an">
              <label class="radio">
                <input type="radio" name="data_type" value="du_an"
                  class="data_type" {du_an} />
                Trang dự án</label>
            </li>

            <li id="service">
              <label class="radio">
                <input type="radio" name="data_type" value="service"
            ...
            <li id="album">
              <label class="radio">
                <input type="radio" name="data_type" value="album"
                  class="data_type" {album} />
                Album ảnh</label>
            </li>
            ...
            <li id="video">
              <label class="radio">
                <input type="radio" name="data_type" value="video"
                  class="data_type" {video} />
                Trang video</label>
            </li>

            <li id="tuyendung">
              <label class="radio">
                <input type="radio" name="data_type" value="tuyendung"
                  class="data_type" {tuyendung} />
            ...
            <!-- <li id="download">
              <label class="radio">
                <input type="radio" name="data_type" value="download"
                  class="data_type" {download} />
                Tài liệu download</label>
            </li> -->

            <li id="partner">
              <label class="radio">
                <input type="radio" name="data_type" value="partner"
                  class="data_type" {partner} />
                Trang Đối tác - Khách hàng</label>
            </li>

            <li id="contact">
              <label class="radio">
                <input type="radio" name="data_type" value="contact"
                  class="data_type" {contact} />
                Trang liên hệ</label>
            </li>
            <li id="logo">
              <label class="radio">
                <input type="radio" name="data_type" value="logo"
                  class="data_type" {logo} />
                Logo - Liên kết web</label>
            </li>

            <li id="home">
              <label class="radio">
                <input type="radio" name="data_type" value="home"
                  class="data_type" {home} />
                Trang chủ</label>
            </li>
<!--
            <li id="support">
              <label class="radio">
                <input type="radio" name="data_type" value="support"
                  class="data_type" {support} />
            ...
            <li id="sitemap">
              <label class="radio">
                <input type="radio" name="data_type" value="sitemap"
                  class="data_type" {sitemap} />
                Sitemap</label>
            </li>

            <li id="tacgia">
              <label class="radio">
                <input type="radio" name="data_type" value="tacgia"
                  class="data_type" {tacgia} />
                Tác giả</label>
            </li>
          ...
          <ul class="fr_location borderleft-dddddd" id="chooselocation">
            ...
            <li id="menutop">
              ...
              <label class="checkbox">
                <input name="vitri[menutop]" type="checkbox" value="menutop"
                  {menutop} />
                Menu top</label>
            </li>
            ...
            <li id="menubar">
              <label class="checkbox">
                <input name="vitri[menubar]" type="checkbox" value="menubar"
                  {menubar} />
                Menu ngang</label>
            </li>
            <!--
            ...
            <li id="menufooter">
              <label class="checkbox">
                <input name="vitri[menufooter]" type="checkbox"
                  value="menufooter" {menufooter} />
                Menu chân trang</label>
            </li>

            <li id="boxmenufooter">
              <label class="checkbox">
                <input name="vitri[boxmenufooter]" type="checkbox"
                  value="boxmenufooter" {boxmenufooter} />
            ...
            <li id="menuleft">
              <label class="checkbox">
                <input name="vitri[menuleft]" type="checkbox" value="menuleft"
                  {menuleft} />
                Menu trái</label>
            </li>
            ...
            <li id="banner">
              <label class="checkbox">
                <input name="vitri[banner]" type="checkbox" value="banner"
                  {banner} />
                Logo-Top</label>
            </li>
            ...
            <li id="logosite">
              <label class="checkbox">
                <input name="vitri[logosite]" type="checkbox" value="logosite"
                  {logosite} />
                Logo</label>
            </li>
            ...
            <li id="slideshow">
              <label class="checkbox">
                <input name="vitri[slideshow]" type="checkbox" value="slideshow"
                  {slideshow} />
                Slide show</label>
            </li>
            ...
            <li id="slidemobile">
              <label class="checkbox">
                <input name="vitri[slidemobile]" type="checkbox"
                  value="slidemobile" {slidemobile} />
                Slide Mobile</label>
            </li>

            <li id="popup">
              <label class="checkbox">
                <input name="vitri[popup]" type="checkbox" value="popup"
                  {popup} />
                Popup</label>
            </li>
            ...
            <li id="cathome">
              <label class="checkbox">
                <input name="vitri[cathome]" type="checkbox" value="cathome"
                  {cathome} />
            ...
            <li id="hothome">
              <label class="checkbox">
                <input name="vitri[hothome]" type="checkbox" value="hothome"
                  {hothome} />
            ...
            <li id="inhome">
              <label class="checkbox">
                <input name="vitri[inhome]" type="checkbox" value="inhome"
                  {inhome} />
            ...
            <li id="inright">
              <label class="checkbox">
                <input name="vitri[inright]" type="checkbox" value="inright"
                  {inright} />
    ...
    <td>
      ...
      <tr>
        ...
        <td>
          <input name="template_name" type="text" style="width:200px;"
            value="{template_name}" />
        ...
        <td><div id="pic_avatar">{image}</div>
          ...
          <div class="input-append">
            <input name="imageurl" type="text" id="imageurl"
              style="height:20px; width:290px;" value="{imageurl}" />
            <button class="btn" type="button" id="browserimage">Chọn ảnh trên
              server</button>
          </div></td>
      </tr>
      <tr>
        ...
        <td><div id="pic_avataradv">{imageadv}</div>
          <div class="c5"></div>
          <div class="input-append">
            <input name="imageurladv" type="text" id="imageurladv"
              style="height:20px; width:290px;" value="{imageurladv}" />
            <button class="btn" type="button" id="browserimageadv">Chọn ảnh trên
              server</button>
          </div></td>
      </tr>
      ...
      <tr>
        ...
        <td><button class="btn btn-info" type="button"
            id="multi_browser_image">Chọn ảnh trên server</button></td>
      </tr>
      <tr>
        <td colspan="2" id="show_collection_cell">
          ...
          <div class="collection_cell">
            <div class="image"><a href="{big_image}" class="highslide"
                onClick="return hs.expand(this)"><img src="{image}"></a></div>
            <input name="image_name[collection_{id}]" type="text"
              class="txtname name_image" placeholder="Tiêu đề..."
              value="{name}" />
            <textarea name="image_desc[collection_{id}]" class="txtname"
              style="height:60px;resize:none; "
              placeholder="Mô tả...">{image_desc}</textarea>
            <div style="padding-left:10px;"><span class="labelorder">Thứ
                tự</span>
              <input name="image_thu_tu[collection_{id}]" type="text"
                class="txtorder image_thu_tu" placeholder="Thứ tự..."
                value="{thu_tu}">
              <a class="btn btn-mini" style="margin-top:2px; margin-left:10px;"
                onClick="delete_multi_image($(this));
                                    return false"><i
                  class="icon-trash"></i>&nbsp;Xóa</a>
              <div style="c"></div>
            </div>
            <input type="hidden" name="image_path[collection_{id}]"
              value="{real_image}" class="collection_image">
          </div>
      ...
      <tr>
        ...
        <td><textarea name="description" id="description"
            class="txtareakeyword-description">{description}</textarea></td>
      </tr>
      <tr>
        <td><strong>Keywords</strong></td>
        <td><textarea name="keywords"
            class="txtareakeyword-description">{keywords}</textarea></td>
      </tr>
      <tr>
        <td><strong>Header tag</strong></td>
        <td><textarea name="header_tag"
            class="txtareakeyword-description">{header_tag}</textarea></td>
      </tr>
      ...
      <tr>
        ...
        <td style="position:relative">
          <div class="input-prepend">
            <span class="add-on">
              <input name="autourl" id="autourl" type="checkbox" value="1"
                {autourl} />
            </span>
            <input class="span2" id="url" name="url" type="text"
              style="width:572px;" value="{url}">
          </div>
          <div style="font-size:11px; color:#666; font-style:italic">Checked tự
            động tạo url/Uncheck lấy url trên ô text</div></td>
      </tr>
      <tr>
        <td><strong>Target blank</strong></td>
        <td><input type="checkbox" name="target" value="1" {targetcheck} />
        </td>
      </tr>

      <tr>
        <td><strong>Kích hoạt</strong></td>
        <td><input type="checkbox" name="active" id="active" value="1"
            {active} /></td>
      </tr>
      <tr>
        <td><strong>Thứ tự</strong></td>
        <td><input type="text" name="thu_tu" id="thu_tu" class="txtorder"
            value="{thu_tu}" /></td>
      </tr>
      <tr>
        <td><strong>Shortcut ra trang chủ quản trị</strong></td>
        <td><input type="checkbox" name="shortinhome" id="shortinhome" value="1"
            {shortinhome} /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><div onclick="$('#inputform').submit();
                        return false" class="btn btn-primary"><i
              class="icon-ok-circle icon-white"></i>&nbsp;Cập nhật</div>
          <div onclick="window.location = '?page={par_page}&pid={pid}'"
            class="btn btn-inverse" style="margin-left:10px;"><i
              class="icon-remove icon-white"></i>&nbsp;Đóng</div></td>
      </tr>
    </table>
  </form>
  ...
  <form action="{action}" method="post" id="list_form">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
      class="table table-bordered table-striped table-hover" id="tablelist">
      <tr>
        <th colspan="7"> <div style="float:left"><i
              class="icon-list-alt"></i>&nbsp;Danh sách {item}</div>
          <a href="?page={par_page}&code=showAddNew&pid={pid}"
            style="float:right">
            <div class="btn  btn-mini"><i class="icon-plus-sign"></i>&nbsp;Thêm
              mới {item}</div>
          </a> </th>
      </tr>
      <tr class="title">
        <td>Tiêu đề
          ...
          <span class="expand-all-child" style="float:right;">&nbsp; Mở rộng
          </span> <span style="float:right;"> / </span> <span
            class="collapse-all-child" style="float:right;"> Thu gọn &nbsp;
          </span>
      ...
      <tr class="{child-cat}">
        <td class="showurl">
          <div style="float:left;" class="list_item_name"><a
              style="{font-weight}" href="{link}">{name}</a></div>

          <span style="font-size:11px; color:#666; display:none"
            class="urlview">{url}</span>

          <span class="expand-child" data-expand="child-cat-{catid}"
            style="float:right;">{expand-icon}</span>

        </td>
        <td class="center">{vitri}</td>
        <td class="center">{datatype}</td>
        <td class="center"><input type="checkbox" name="active" value="1"
            data-active="{id}" {active} class="changeactive" /></td>
        <td><input type="text" name="thu_tu[{id}]" class="txtorder"
            value="{thu_tu}" /></td>
        <td><a href="{link_edit}" class="btn padingleftright4"><i
              class="icon-wrench"></i></a></td>
        <td><a href="{link_delete}" class="btn padingleftright4 trash_item"><i
      ...
      <tr class="title">
        ...
        <td colspan="2"><a href="#" onclick="$('#list_form').submit();
                        return false" class="btn btn-inverse"
            style="margin-left:30px">Cập nhật</a></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
