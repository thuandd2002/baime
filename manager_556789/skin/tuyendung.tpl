...
<div class="wraper-content">
  ...
  <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td><input type="text" name="name" class="txtform100 notNull" value="{name}"
            data-alert="Bạn cần nhập vào tiêu đề {item}" /></td>
      </tr>

      <tr>
        <td width="150"><strong>Tên viết tắt</strong></td>
        <td><input type="text" name="short_name" class="txtform100" value="{short_name}" /></td>
      </tr>
      ...
      <tr>
        ...
        <td><input type="text" name="tencongty" class="txtform100" value="{tencongty}" /></td>
      </tr>

      <tr>
        <td><strong>Nơi làm việc</strong></td>
        <td><input type="text" name="noilamviec" class="txtform100" value="{diadiem}" /></td>
      </tr>

      <tr>
        <td><strong>Ngày hết hạn</strong></td>
        <td><input type="text" name="ngayhethan" id="ngay_het_han" value="{ngayhethan}" /></td>
      </tr>

      <tr>
        <td><strong>Số lượng</strong></td>
        <td><input type="text" name="soluong" value="{soluong}" /></td>
      </tr>
      ...
      <tr>
        <td valign="top"><strong>Thông tin công ty</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top"><strong>Thông tin tuyển dụng</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2">
      ...
      <tr>
        ...
        <td style="position:relative"><input type="text" name="ngay_dang" id="ngay_dang" style="width:100px;"
            value="{ngay_dang}" /></td>
      </tr>
      <tr>
        ...
        <td style="position:relative">
          ...
          <div style="font-size:11px; color:#666; font-style:italic">Checked tự động tạo url/Uncheck lấy url trên ô text
          </div>
        </td>
      </tr>
  ...
  <script type="text/javascript">
    $(function () {
      $('#ngay_dang, #ngay_het_han').datepicker({
        duration: '',
        showTime: true,
  ...
  <form action="{action}" method="post" id="list_form">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
      ...
      <tr class="search_box nonehover">
        <td colspan="7">
          <div class="form-search" style="margin:0px;">
            <div class="input-append">
              <input type="text" id="keyword" name="keyword" class="search-query" style="height:20px;"
      ...
      <tr class="title">
        <td width="16"><input type="checkbox" name="checkbox" id="checkbox" class="cat_check" data-check="cat_check"
            onclick="check_all(this)" /></td>
        <td>Tiêu đề</td>
      ...
      <tr>
        ...
        <td>
          <a href="{link_edit}">{image}</a>
          <div class="list_item_name"><a href="{link_edit}">{name}</a></div>
          <div class="info_item"><strong>Người đăng:</strong> {user_name} [{username}] - <strong>Ngày:</strong>
            {createdate}</div>
      ...
      <tr class="title">
        <td width="16"><input type="checkbox" name="checkbox" id="checkbox" class="cat_check"
            onclick="check_all($(this))" /></td>
