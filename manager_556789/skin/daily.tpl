            ...
            $(function () {
              ...
              $('#tinhthanh').change(function () {
                if ($('#tinhthanh').val() != 0) {
                  ...
                  $('#quanhuyen').load('/index4.php?page=11&code=getDistrict&id=' + $('#tinhthanh').val() + '&selectedid=' + {districtid});
                } else {
      ...
      <tr class="search_box nonehover">
        <td colspan="7">
          <div class="form-search" style="margin:0px;">
            <div class="input-append">
              <input type="text" class=" search-query" id="keyword" name="keyword" style="height:20px;"
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyDlLCyGciPsbFRoHB-HiapPKba0_r6TGEQ"
