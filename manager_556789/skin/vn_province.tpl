...
<div class="wraper-content">
    ...
    <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
			...
			<tr>
                <td width="150"><strong>Mã tỉnh thành</strong></td>
                <td><input type="text" name="ma"  value="{ma}" /> </td>
            </tr>			
            ...
            <tr>
                <td width="150"><strong>Nhóm</strong></td>
                <td> {parentid} </td>
            </tr>
			
			<tr>
                <td width="150"><strong>Loại</strong></td>
                <td><input type="text" name="type"  value="{type}" /> </td>
            </tr>			

			<tr>
                <td width="150"><strong>Mã khu vực</strong></td>
                <td><input type="text" name="khu_vuc"  value="{khu_vuc}" /> </td>
            </tr>
    ...
    <form action="{action}" method="post" id="list_form">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-hover">
            ...
            <tr class="title">
				...
				<td width="80" align="center" class="center">Mã tỉnh thành</td>
                <td>Tiêu đề</td>
				
				<td width="150" align="center" class="center">Loại hình</td>
				<td width="180" align="center" class="center">Danh mục</td>
