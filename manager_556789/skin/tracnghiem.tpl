	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
		...
		<tr>
            ...
            <!-- START BLOCK : dapan -->
            <div class="phien-ban">
                <input type="text"  placeholder="Đáp án" name="dapan[]" value="{dapan}" style="width:50px; "  />
				<input type="text" placeholder="Tên đáp án" name="motadapan[]" value="{motadapan}" style="width:400px;" />đ
                <input type="text"  placeholder="Điểm" name="diem[]" value="{diem}" style="width:50px; "  />
                
                <a class="xoa" onclick="xoa($(this)); return false;">Xóa (-)</a>
                <div class="c10"></div>
            </div>
            <!-- END BLOCK : dapan -->
            <div class="phien-ban">
				
                <input type="text"  placeholder="Đáp Án" name="dapan[]" style="width:50px; "  />
				<input type="text" placeholder="Tên đáp án" name="motadapan[]" style="width:400px;" />đ
                <input type="text"  placeholder="Điểm" name="diem[]" style="width:50px; "  />

                <a class="xoa" onclick="xoa($(this));
                                return false;">Xóa (-)</a>
                <div class="c10"></div>
            </div>					


            <div class="them" style="font-weight: bold; margin-top: 10px;">(+)Thêm</div>

            <script>

                $(".them").click(function () {
                    var abc = $(".phien-ban").html();
                    $(' <div class="phien-ban"> ' + abc + ' </div> ').insertBefore($(this));
