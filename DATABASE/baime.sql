...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 04, 2026 lúc 04:50 PM
...
(12, 'Tin tức', 'Tin tức', 'Tin tức', 0, 9, 1, '', '', '', '', 'tin-tuc/', '', ':menubar:', 'news', '0', '', '', NULL, '', 0, '', NULL, 21, 0, 0, 0, 0, 0, 0, '', NULL, 0, '', 0, '', 0, '', '', 1780311242),
...
--
ALTER TABLE `news`
  MODIFY `id_news` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `search_content`
  MODIFY `id_search` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
